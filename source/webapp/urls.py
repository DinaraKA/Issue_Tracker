...
from .views import IndexView, TaskView, TaskCreateView, TaskUpdateView, TaskDeleteView,\
    ...
    ProjectCreateView, ProjectUpdateView, ProjectDeleteView, ProjectUsersUpdate
...
urlpatterns = [
    ...
    path('projects/<int:pk>/add_user/', ProjectUsersUpdate.as_view(), name='project_add_user')
]
